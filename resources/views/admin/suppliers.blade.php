...
<div class="container pt-5 pb-5">
    ...
    @endif
         <div class="fs-4 text-center fw-bold p-3">Suppliers</div>
         <div class="main">
           <form action="{{url('admin/searchsupplier')}}" method="POST" >
            @csrf
        ...
        <a href="{{url('admin/addsupplier')}}" class="btn btn-secondary text-white mb-3">Add Supplier</a>
        <div class="tablehead text-center d-flex justify-content-around align-items-center  pt-2 pb-2 bg-danger rounded-top  text-white fw-bold">
            ...
            <div class="col-3">Create At</div>
            <div class="col-2">count Number of Products </div>
        ...
        @if (! $sups->isEmpty())
            ...
            <div class="tablebody  text-center  d-flex justify-content-around align-items-center pt-2 pb-2 fw-bold shadow-sm">
              ...
              <div class="col-3">{{$cat->created_at}}</div>
              <div class="col-2">{{$cat->shipment_no}}</div>
              <div class="col-2"><a href="{{url("admin/editsupplier/$cat->id")}}"><i class="fa fa-pen-nib "></i></a></div>
