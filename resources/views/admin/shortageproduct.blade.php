...
<div class="container pt-5 pb-5">
    ...
    @endif
         <div class="fs-4 text-center fw-bold p-3">Shortage Products</div>
         <div class="main">
        ...
        <a href="{{url('admin/addshipment')}}" class="btn btn-secondary text-white mb-3">Make Shipemt</a>
        <a href="{{url('admin/products')}}" class="btn btn-danger mb-3">Back</a>
