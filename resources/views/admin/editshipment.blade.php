...
<div class="container pt-5">
    <div class="product-contain m-auto">
        <div class="pb-5 fs-4 fw-bold text-black"><span class="text-danger">Edit</span> Shipment</div>
        <form action="{{url('admin/updateshipment')}}" method="POST">
            @csrf
            <label for="name" class="pb-2">Enter Name of Shipment</label>
            <input type="text" class="form-control mb-3" value="{{$shipment->shipment_items}}"  id="name" name="name" placeholder=" ">
            @error("name")
